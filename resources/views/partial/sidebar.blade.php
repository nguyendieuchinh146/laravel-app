<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
    <div class="sidebar-brand d-none d-md-flex">
        <svg class="sidebar-brand-full" width="118" height="46" alt="CoreUI Logo">
            <use xlink:href="{{ asset('../resources/themes/admin/brand/coreui.svg#full') }}"></use>
        </svg>
        <svg class="sidebar-brand-narrow" width="46" height="46" alt="CoreUI Logo">
            <use xlink:href="{{ asset('../resources/themes/admin/brand/coreui.svg#signet') }}"></use>
        </svg>
    </div>
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        <li class="nav-item"><a class="nav-link" href="index.html">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('../resources/themes/admin/icons/svg/free.svg#cil-speedometer') }}"></use>
                </svg> Dashboard<span class="badge badge-sm bg-info ms-auto">NEW</span></a></li>
        <li class="nav-title">Theme</li>
        <li class="nav-item"><a class="nav-link" href="{{route('cars.list')}}">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('../resources/themes/admin/icons/svg/free.svg#cil-drop') }}"></use>
                </svg> Cars</a></li>
        <li class="nav-item"><a class="nav-link" href="{{route('admin.course.list')}}">
                <svg class="nav-icon">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('../resources/themes/admin/icons/svg/free.svg#cil-puzzle') }}"></use>
                </svg> Base</a>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('../resources/themes/admin/icons/svg/free.svg#cil-cursor') }}"></use>
                </svg> Buttons</a>
            <ul class="nav-group-items">
        ...
        <li class="nav-item"><a class="nav-link" href="charts.html">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('../resources/themes/admin/icons/svg/free.svg#cil-chart-pie') }}"></use>
                </svg> Charts</a></li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('../resources/themes/admin/icons/svg/free.svg#cil-notes') }}"></use>
                </svg> Forms</a>
            <ul class="nav-group-items">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('../resources/themes/admin/icons/svg/free.svg#cil-star') }}"></use>
                </svg> Icons</a>
            <ul class="nav-group-items">
        ...
        <li class="nav-item"><a class="nav-link" href="widgets.html">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('../resources/themes/admin/icons/svg/free.svg#cil-calculator') }}"></use>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            <ul class="nav-group-items">
                <li class="nav-item"><a class="nav-link" href="login.html" target="_top">
                        <svg class="nav-icon">
                            <use xlink:href="{{ asset('../resources/themes/admin/icons/svg/free.svg#cil-account-logout') }}"></use>
                        </svg> Login</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="404.html" target="_top">
                        <svg class="nav-icon">
                            <use xlink:href="{{ asset('../resources/themes/admin/icons/svg/free.svg#cil-bug') }}"></use>
                        </svg> Error 404</a></li>
